...
(program
 ...
 (set-global! vec ((get-global List) (dict (0 2) (1 4) (2 6))))
 (py-print
  ((get-global List)
  ...
  ((get-global List)
   (let ((res (dict)) ($i 0) (x (void)))
     (for-each
      ...
      (get-global vec)
      (begin
        (dict-set! res $i ((get-global List) (dict (0 x) (1 (expt x 2)))))
        (set! $i (+ $i 1))))
     res)))
 (set-global!
  freshfruit
  ((get-global List)
   (dict (0 " banana") (1 "  loganberry ") (2 "passion fruit  "))))
 (py-print
  ((get-global List)
   (let ((res (dict)) ($i 0) (weapon (void)))
     (for-each
      weapon
      (get-global freshfruit)
      (begin (dict-set! res $i weapon) (set! $i (+ $i 1))))
     res)))
 (py-print
  ((get-global List)
   (let ((res (dict)) ($i 0) (x (void)))
  ...
  ((get-global List)
   (let ((res (dict)) ($i 0) (x (void)))
     (for-each
      ...
      (get-global vec)
      (begin
        (dict-set! res $i ((get-global tuple) (dict (0 x) (1 (expt x 2)))))
        (set! $i (+ $i 1))))
     res))))
