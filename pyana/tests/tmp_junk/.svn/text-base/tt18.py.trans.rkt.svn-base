        ...
        (let ((container (dict-ref self "__containerdict__"))
          ...
          (while
           ...
           (cond
            ...
            (else (set! i (+ i 1)))))
          cnt)))))))
 (set-global! x (get-global o))
 (set-field! (get-global x) "a" 1)
 (set-field! (get-global x) "b" #f)
 (set-field! (get-global o) "b" "hi")
 (set-global! y (get-field (get-global x) "b"))
 (set-global! z (get-field (get-global o) "b")))
