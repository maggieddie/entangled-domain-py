...
(program
 ...
 (begin
   ...
   (set! g$y g$o)
   (set-field! g$w "a" 2)
   (set! g$z (get-field g$y "a"))
   (set! g$foo
     (lambda (obj)
       (call/ec
        (lambda (return) (begin (set-field! obj "b" "Hi") (return obj))))))
   (set! g$qx (g$foo g$w))
   (set! g$res (get-field g$w "b"))
   (set! g$p (get-field g$qx "b"))
   (set! g$res2 (get-field g$o "b"))
   (set! g$resy (get-field g$y "b"))
   (set! g$res_historyA (get-field g$w "a"))))
