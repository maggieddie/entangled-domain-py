 ...
 (set-global!
  ...
  (lambda (lst)
    (call/ec
     (lambda (return)
       (let ((newlst (void)))
         (set! newlst ((get-global List) (dict (0 1) (1 3) (2 5))))
         (set! lst newlst)
         (return newlst))))))
 (set-global! lst1 ((get-global List) (dict (0 2) (1 4) (2 6))))
 (py-print ((get-global change_list) (get-global lst1))))
