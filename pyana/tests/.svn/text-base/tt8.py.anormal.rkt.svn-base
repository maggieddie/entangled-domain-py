                ...
                (call/ec
                 (lambda (return)
                   (let (($localo15
                     ...
                     (let ((b3 (get-field $localo15 "__init__")))
                       (let ((_4 (b3 tmp-dict14)))
                         (let ((b5 (return $localo15))) b5)))))))))
         (let ((_7 (set! List b6)))
           (let ((_8 (void)))
             (let ((b12
                    (lambda (tmp-dict17)
                       ...
                       (lambda (return)
                         (let (($localo18
                                (dict
                                 ("__class__" set)
                                 ("__type__" "instSet"))))
                           (let ((b9 (get-field $localo18 "__init__")))
                             (let ((_10 (b9 tmp-dict17)))
                               (let ((b11 (return $localo18))) b11)))))))))
               (let ((_13 (set! set b12)))
                 (let ((_14 (void)))
                   (let ((b18
                          (lambda (tmp-dict20)
                             ...
                             (lambda (return)
                               (let (($localo21
                                      (dict
                                       ("__class__" tuple)
                                       ("__type__" "instTuple"))))
                                 (let ((b15 (get-field $localo21 "__init__")))
                                   (let ((_16 (b15 tmp-dict20)))
                                     (let ((b17 (return $localo21)))
                                       b17)))))))))
