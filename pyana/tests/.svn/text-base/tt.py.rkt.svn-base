                ...
                (call/ec
                 (lambda (return)
                   (let (($localo19
                     ...
                     (let ((b3 (get-field $localo19 "__init__")))
                       (let ((_4 (b3 tmp-dict18)))
                         (let ((b5 (return $localo19))) b5)))))))))
         (let ((_7 (set! List b6)))
           (let ((_8 (void)))
             (let ((b12
                    (lambda (tmp-dict21)
                       ...
                       (lambda (return)
                         (let (($localo22
                                (dict
                                 ("__class__" set)
                                 ("__type__" "instSet"))))
                           (let ((b9 (get-field $localo22 "__init__")))
                             (let ((_10 (b9 tmp-dict21)))
                               (let ((b11 (return $localo22))) b11)))))))))
               (let ((_13 (set! set b12)))
                 (let ((_14 (void)))
                   (let ((b18
                          (lambda (tmp-dict24)
                             ...
                             (lambda (return)
                               (let (($localo25
                                      (dict
                                       ("__class__" tuple)
                                       ("__type__" "instTuple"))))
                                 (let ((b15 (get-field $localo25 "__init__")))
                                   (let ((_16 (b15 tmp-dict24)))
                                     (let ((b17 (return $localo25)))
                                       b17)))))))))
                                                      ...
                                                      (let ((max35
                                                        ...
                                                        (let ((_72
                                                          ...
                                                          (let ((b73 cnt))
                                                            b73)))))))))
                                         (let ((b77
                                                (lambda (self36 elem37)
                                                  (let ((max38 (len self36)))
                                                    (let ((b76
                                                           (dict-ref
                                                            self36
                                                            "__containerdict__")))
                                                                                                ...
                                                                                                (let ((b187
                                                                                                  ...
                                                                                                  (if b187
                                                                                                    ...
                                                                                                    (let ((b190
                                                                                                      ...
                                                                                                      (if b190
                                                                                                        (error
                                                                                                         "cannot set string with non-char/string value")
                                                                                                        (void))))))))
                                                                                         (let ((b182
                                                                                                b183))
                                                                                           (let ((_191
