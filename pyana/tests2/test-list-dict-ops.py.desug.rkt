...
(program
 ...
 (begin
   ...
   (set! g$lst (List (dict (0 "A") (1 "A") (2 "C") (3 "D"))))
   (py-print g$lst)
   (py-print ((get-field g$lst "count") "A"))
   ((get-field g$lst "insert") 0 "a")
   (py-print g$lst)
   ((get-field g$lst "insert") 5 "E")
   (py-print g$lst)
   ((get-field g$lst "insert") 3 "b")
   (py-print g$lst)
   (py-print ((get-field g$lst "count") "A"))
   (py-print ((get-field g$lst "count") "F"))
   (py-print ((get-field g$lst "index") "A"))
   (py-print ((get-field g$lst "index") "F"))))
