                ...
                (call/ec
                 (lambda (return)
                   (let (($localo16
                     ...
                     (let ((b3 (get-field $localo16 "__init__")))
                       (let ((_4 (b3 tmp-dict15)))
                         (let ((b5 (return $localo16))) b5)))))))))
         (let ((_7 (set! List b6)))
           (let ((_8 (void)))
             (let ((b12
                    (lambda (tmp-dict18)
                       ...
                       (lambda (return)
                         (let (($localo19
                                (dict
                                 ("__class__" set)
                                 ("__type__" "instSet"))))
                           (let ((b9 (get-field $localo19 "__init__")))
                             (let ((_10 (b9 tmp-dict18)))
                               (let ((b11 (return $localo19))) b11)))))))))
               (let ((_13 (set! set b12)))
                 (let ((_14 (void)))
                   (let ((b18
                          (lambda (tmp-dict21)
                             ...
                             (lambda (return)
                               (let (($localo22
                                      (dict
                                       ("__class__" tuple)
                                       ("__type__" "instTuple"))))
                                 (let ((b15 (get-field $localo22 "__init__")))
                                   (let ((_16 (b15 tmp-dict21)))
                                     (let ((b17 (return $localo22)))
                                       b17)))))))))
